...
`Peer.Send(byte channelID, byte[] data, int length)` queues a packet to be sent. Optionally, an array of bytes with a specified length can be passed to the parameters instead of the packet.
